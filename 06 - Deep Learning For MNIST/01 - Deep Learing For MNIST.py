...
W4 = tf.get_variable("W4",shape=[312,256],initializer=xavier_init(312,256))
W5 = tf.get_variable("W5",shape=[256,10],initializer=xavier_init(256,10))  #xavier_init으로 W setting
